...
const Formulaire = () => {
  ...
  const sendMail = async (e) => {
    ...
    try {
      ...
      formData.append("phone_number", numtelephone);
      formData.append("numbercmd", nbcommands);
  ...
  return (
    <div
      id="all7"
      className="bg-gradient-to-r from-firstbule via-secondule to-trithbule flex flex-col items-center justify-start text-white overflow-hidden shadow-2xl"
    >
      <div className="flex items-center justify-center mt-10">
        <Image
          ...
          objectFit="contain"
        />
        <h1 id="tit11" className="text-5xl text-white font-arabic">
          &nbsp;بغيت نخدم مع
        </h1>
      </div>
      <form id="form2" onSubmit={sendMail}>
        <div
          id="forms1"
          className="flex justify-center items-center mr-24 mt-10 "
        >
          <div id="into" className="relative">
            ...
            <FaPhone
              id="into1"
              className="absolute top-1/2 transform -translate-y-1/2 right-4 text-black"
            />
          </div>
        ...
        <div>
          <button
            id="irsal"
            type="submit"
            className="flex-1 mt-9 ml-56 text-center w-80 py-2 rounded-lg bg-amber-600 font-arabic"
          >
            إرسال
          </button>
        </div>
